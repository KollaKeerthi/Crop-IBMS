...
export const CreateCropDataInputSchema = z.object({
  ...
  blockMasterId: z.string().uuid(),
  locationBlockId: z.string().uuid().nullish(),
  block: z.string().trim().min(1, "Block is required."),
  fieldName: z.string().optional(),
  fieldCode: z.string().optional(),
  sexExpression: SexExpressionSchema,
...
export const CropDataSchema = z.object({
  ...
  blockMasterId: z.string().uuid().nullable().optional(),
  locationBlockId: z.string().uuid().nullable().optional(),
