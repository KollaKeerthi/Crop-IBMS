...
export const CreateActiveTimeInputSchema = z.object({
  ...
  materialArrival: z.string().trim().max(200).optional(),
  sowingMale: z.string().trim().max(200).optional(),
  sowingFemale: z.string().trim().max(200).optional(),
  plantingMale: z.string().trim().max(200).optional(),
  plantingFemale: z.string().trim().max(200).optional(),
  pollinationStart: z.string().trim().max(200).optional(),
  pollinationEnd: z.string().trim().max(200).optional(),
  harvestingStart: z.string().trim().max(200).optional(),
  harvestingEnd: z.string().trim().max(200).optional(),
...
export const UpdateActiveTimeInputSchema = z.object({
  ...
  materialArrival: z.string().trim().max(200).optional().nullable(),
  sowingMale: z.string().trim().max(200).optional().nullable(),
  sowingFemale: z.string().trim().max(200).optional().nullable(),
  plantingMale: z.string().trim().max(200).optional().nullable(),
  plantingFemale: z.string().trim().max(200).optional().nullable(),
  pollinationStart: z.string().trim().max(200).optional().nullable(),
  pollinationEnd: z.string().trim().max(200).optional().nullable(),
  harvestingStart: z.string().trim().max(200).optional().nullable(),
  harvestingEnd: z.string().trim().max(200).optional().nullable(),
...
export const ActiveTimeSchema = z.object({
  ...
  materialArrival: z.string().nullable(),
  sowingMale: z.string().nullable(),
  sowingFemale: z.string().nullable(),
  plantingMale: z.string().nullable(),
  plantingFemale: z.string().nullable(),
  pollinationStart: z.string().nullable(),
  pollinationEnd: z.string().nullable(),
  harvestingStart: z.string().nullable(),
  harvestingEnd: z.string().nullable(),
  isActive: z.boolean(),
  notes: z.string().nullable(),
  createdAt: z.string(),
